...
class WOFHumanPlayer(WOFPlayer):
    ...
    def getMove(category, obscuredPhrase, guessed):
        print("""{} has {}/n/nCategory: {}/nPhrase: {}/nGuessed: {}/n/nGuess a letter,
        phrase or type 'exit' or 'pass':""" + input(x))
        return x
